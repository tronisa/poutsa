...
################################################################################
[Defines]
  PLATFORM_NAME                  = Warlock
  PLATFORM_GUID                  = b6325ac2-9f3f-4b1d-b129-ac7b35ddde62
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/WarlockPkg
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = WarlockPkg/Warlock.fdf
  SECURE_BOOT                    = 1
...
!include WarlockPkg/Device/$(TARGET_DEVICE)/Defines.dsc.inc
...
[PcdsFixedAtBuild.common]
  ...
  gAndromedaPkgTokenSpaceGuid.PcdABLProduct|"warlock"
...
!include WarlockPkg/Device/$(TARGET_DEVICE)/DXE.dsc.inc

[LibraryClasses.common]
  # Move PlatformMemoryMapLib to Device/<device>/Library
  PlatformMemoryMapLib|WarlockPkg/Device/$(TARGET_DEVICE)/Library/PlatformMemoryMapLib/PlatformMemoryMapLib.inf

  # Move PlatformConfigurationMapLib to Device/<device>/Library
  PlatformConfigurationMapLib|WarlockPkg/Device/$(TARGET_DEVICE)/Library/PlatformConfigurationMapLib/PlatformConfigurationMapLib.inf
...
!include WarlockPkg/Device/$(TARGET_DEVICE)/PcdsFixedAtBuild.dsc.inc
